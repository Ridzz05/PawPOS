...
// Pure, permanent light theme instance for the standalone landing page
const landingTheme = getTheme('light')
...
export function LandingPage() {
  ...
  // Enforce light theme isolation for the landing page without altering app preferences permanently
  useEffect(() => {
  ...
  return (
    <ThemeProvider theme={landingTheme}>
      <Box sx={{ minHeight: '100vh', bgcolor: '#FAFAFC', color: '#0F172A', overflowX: 'hidden' }}>
        ...
        >
          ...
          >
            <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 2 }}>
              ...
              />
              <IconButton onClick={() => setMobileMenuOpen(false)} size="small" sx={{ color: '#64748B' }}>
                <CloseOutlined />
              </IconButton>
            </Stack>
          ...
          <Container maxWidth="lg">
            ...
            <Box sx={{ position: 'relative', mx: 'auto', maxWidth: 1040 }}>
              ...
              >
                ...
                <Box>
                  <Typography sx={{ fontWeight: 850, fontSize: '0.86rem', color: '#0F172A' }}>
              ...
              >
                ...
                >
                  ...
                  <Box sx={{ textAlign: 'left' }}>
                    <Typography sx={{ fontWeight: 800, fontSize: '0.75rem', color: '#0F172A', lineHeight: 1.2 }}>
                      Split Payment Sukses
                    </Typography>
        ...
        <Box sx={{ py: 6, bgcolor: '#ffffff', borderTop: '1px solid', borderBottom: '1px solid', borderColor: '#E2E8F0' }}>
          <Container maxWidth="lg">
            <Box
              sx={{
                display: 'grid',
        ...
        <Box id="features" component="section" sx={{ py: { xs: 8, md: 14 } }}>
          <Container maxWidth="lg">
            <Stack spacing={2} textAlign="center" alignItems="center" sx={{ mb: 8 }}>
              <Chip
                label="FITUR OPERASIONAL LENGKAP"
                sx={{
                  bgcolor: '#FFF5ED',
                  color: '#FF8A3D',
                  fontWeight: 800,
              ...
              />
              <Typography variant="h3" component="h2" sx={{ fontWeight: 850, fontSize: { xs: '1.8rem', sm: '2.5rem' }, color: '#0F172A' }}>
              ...
              >
                <Box sx={{ flex: 1, width: { xs: '100%', md: '50%' } }}>
                  <Stack spacing={2.5}>
                    ...
                    />
                    <Typography variant="h4" component="h3" sx={{ fontWeight: 850, color: '#0F172A', fontSize: { xs: '1.5rem', sm: '2rem' } }}>
                    ...
                    <Stack spacing={1.5} sx={{ pt: 1 }}>
                      <Typography sx={{ display: 'flex', alignItems: 'center', gap: 1, fontWeight: 700, fontSize: '0.92rem', color: '#0F172A' }}>
        ...
        <Box sx={{ py: { xs: 8, md: 12 }, bgcolor: '#FFF5ED', borderTop: '1px solid', borderBottom: '1px solid', borderColor: '#FFE3CC' }}>
          <Container maxWidth="md">
            <Stack spacing={2} textAlign="center" alignItems="center" sx={{ mb: 5 }}>
              ...
              <Typography variant="h3" component="h2" sx={{ fontWeight: 850, fontSize: { xs: '1.8rem', sm: '2.4rem' }, color: '#0F172A' }}>
            ...
            >
              ...
              {/* Question Bubble */}
              <Box sx={{ p: 2, bgcolor: '#F8FAFC', borderRadius: '16px', mb: 2.5, border: '1px solid', borderColor: '#E2E8F0' }}>
                <Typography variant="caption" sx={{ color: '#64748B', fontWeight: 700 }}>
                  Pertanyaan Kasir:
                </Typography>
                <Typography sx={{ fontWeight: 750, color: '#0F172A', fontSize: '1rem', mt: 0.5 }}>
              ...
              <Box sx={{ height: '100%' }}>
                ...
                >
                  <Box>
                    ...
                    <Stack spacing={1.5}>
                      <Typography variant="body2" sx={{ display: 'flex', alignItems: 'center', gap: 1, fontWeight: 600, color: '#0F172A' }}>
              ...
              <Box sx={{ height: '100%' }}>
                ...
                >
                  ...
                  <Box>
                    ...
                    <Divider sx={{ mb: 3, borderColor: '#E2E8F0' }} />
                    <Stack spacing={1.5}>
                      <Typography variant="body2" sx={{ display: 'flex', alignItems: 'center', gap: 1, fontWeight: 700, color: '#0F172A' }}>
        ...
        {/* 7. TESTIMONIALS */}
        <Box id="testimonials" sx={{ py: { xs: 8, md: 12 }, bgcolor: '#ffffff', borderTop: '1px solid', borderColor: '#E2E8F0' }}>
          <Container maxWidth="lg">
            ...
            >
              <Box sx={{ height: '100%' }}>
                <Paper sx={{ p: 3.5, borderRadius: '20px', border: '1px solid', borderColor: '#E2E8F0', bgcolor: '#ffffff', height: '100%' }}>
                  <Stack spacing={2}>
                    ...
                    <Stack direction="row" spacing={1.5} alignItems="center" sx={{ pt: 1 }}>
                      ...
                      <Box>
                        <Typography sx={{ fontWeight: 800, fontSize: '0.9rem', color: '#0F172A' }}>Budi Kurniawan</Typography>
                ...
                <Paper sx={{ p: 3.5, borderRadius: '20px', border: '1px solid', borderColor: '#E2E8F0', bgcolor: '#ffffff', height: '100%' }}>
                  <Stack spacing={2}>
                    ...
                    <Stack direction="row" spacing={1.5} alignItems="center" sx={{ pt: 1 }}>
                      ...
                      <Box>
                        <Typography sx={{ fontWeight: 800, fontSize: '0.9rem', color: '#0F172A' }}>drh. Jessica Tan</Typography>
                ...
                <Paper sx={{ p: 3.5, borderRadius: '20px', border: '1px solid', borderColor: '#E2E8F0', bgcolor: '#ffffff', height: '100%' }}>
                  <Stack spacing={2}>
                    ...
                    <Stack direction="row" spacing={1.5} alignItems="center" sx={{ pt: 1 }}>
                      ...
                      <Box>
                        <Typography sx={{ fontWeight: 800, fontSize: '0.9rem', color: '#0F172A' }}>Andi Lestari</Typography>
        ...
        <Box sx={{ py: { xs: 8, md: 12 }, bgcolor: '#1E293B', color: '#ffffff', textAlign: 'center', borderTop: '1px solid', borderColor: 'transparent' }}>
          <Container maxWidth="md">
        ...
        {/* 9. FOOTER */}
        <Box sx={{ py: 6, bgcolor: '#0F172A', color: '#94A3B8', borderTop: '1px solid', borderColor: '#334155' }}>
          <Container maxWidth="lg">
            <Box
              sx={{
                display: 'grid',
